    ...
    <div style={{ maxWidth: 600, margin: '2rem auto', padding: '0 1rem' }}>
      ...
      <div style={{ marginTop: 32, padding: 16, background: '#f0fdf4', borderRadius: 8, border: '1px solid #bbf7d0' }}>
        <p style={{ margin: 0, fontSize: 14, color: '#166534' }}>
          ...
          <a href={`https://wa.me/254114525941?text=${encodeURIComponent(waMessage)}`} target="_blank" rel="noopener noreferrer" style={{ color: '#16a34a', fontWeight: 600 }}>Chat with us on WhatsApp</a>
        </p>
      </div>
    </div>
  );
