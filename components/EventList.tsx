          ...
          return (
            <div key={e.id} style={{ position: 'relative', background: '#121212', borderRadius: 12, overflow: 'hidden', border: '1px solid #1f1f1f', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.5)' }}>
              ...
              <div style={{ padding: 16 }}>
                <h3 className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400" style={{ fontSize: 17, marginBottom: 4 }}>
                  {e.title}
                </h3>
                {e.organizer_id && e.organizer_name && (
                  ...
                  >
                    ...
                    {e.organizer_verified && (
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="text-cyan-400 shrink-0" style={{ width: 13, height: 13 }}>
