              ...
              <div style={{ position: 'relative', height: 180, background: '#1a1a1a' }}>
                ...
                <div style={{ position: 'absolute', top: 10, right: 10, display: 'flex', flexDirection: 'column', gap: 6, alignItems: 'flex-end' }}>
                  {(e.has_flash_sale === true || e.has_flash_sale === 1 || e.has_flash_sale === 't') && !isPastEvent && !isCancelled && (
                    <div style={{ background: 'linear-gradient(to right, #f59e0b, #ef4444)', color: '#fff', padding: '4px 8px', borderRadius: 4, fontSize: 11, fontWeight: 800, letterSpacing: '0.03em' }} className="flash-sale-badge flash-sale-badge">FLASH SALE</div>
                  )}
                  {isCancelled ? (
