      ...
      <div className="w-full max-w-[920px] mx-auto">
        ...
        >
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse at 15% 80%, rgba(251,191,36,0.35), transparent 50%), radial-gradient(ellipse at 90% 20%, rgba(99,102,241,0.2), transparent 40%)',
            }}
          />

          <div className="relative flex flex-[1.55] flex-col justify-between p-3 sm:p-5 md:p-6 text-left min-w-0">
            <div>
              <p
            ...
            <div className="mt-2 space-y-1 min-w-0">
              ...
              <p
                ...
                style={{
                  color: '#c7d2fe',
                  fontSize: 'clamp(0.6rem, 1.7vw, 0.8rem)',
                  fontWeight: 700,
                }}
              >
                {code}
          ...
          <div
            className="relative z-10 flex w-3 sm:w-4 flex-shrink-0 flex-col items-center justify-between py-2"
            aria-hidden
          >
            <div
            ...
            />
            <div
              className="relative z-10 h-3 w-3 sm:h-4 sm:w-4 rounded-full"
              style={{ background: '#0a0a0a', marginTop: -6 }}
            />
            <div
              className="relative z-10 h-3 w-3 sm:h-4 sm:w-4 rounded-full"
              style={{ background: '#0a0a0a', marginBottom: -6 }}
            />
          </div>
          ...
          >
            ...
            <div
              className="rounded-lg sm:rounded-xl border-2 p-1 sm:p-1.5 bg-white"
            ...
            {isUsed && (
              <div
                ...
                style={{ background: 'rgba(127,29,29,0.82)' }}
              >
                <div className="text-center px-2">
                  <p className="text-white font-extrabold text-sm sm:text-base">Already scanned</p>
                  {checkedInAt && (
                    <p className="text-red-100 text-[10px] sm:text-xs mt-1">
